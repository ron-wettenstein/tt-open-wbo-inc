...
#define __GMP_CC "/usr/intel/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -fPIC  -I/usr/intel/pkgs/libgmp/5.0.2/include -L/usr/intel/pkgs/libgmp/5.0.2/lib -L/usr/intel/pkgs/libgmp/5.0.2/lib"
